...
from feedback_receiver.updaters import FeedbackReceiverUpdater
from feedback_receiver.extensions import FeedbackReceiverEvaluator, visualize
...
def main():
    ...
    updater = FeedbackReceiverUpdater(
        models=(fbr, gen, sim),
        iterator=train_iter,
        optimizer=optimizer,
        data=train_data,
    ...
    out_path = args.data_dir + 'feedback_receiver/' + args.out
